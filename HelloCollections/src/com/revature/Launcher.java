...
public class Launcher {
    ...
    public static void main(String[] args) {
        ...
        pokemonList.set(5, new Pokemon("Mewtow", "Psychic"));
        ...
        pokemonSet.add(new Pokemon("Arbok", "Poisomn"));
        ...
        //this is legal, because of the "new" keyword. It's a new object is memory
        pokemonSet.add(new Pokemon("Bulbasaur", "Grass/Poison"));

        //Sets don't allow duplicates. Let's add the same object twice to demonstrate this
        ...
        //A new bulbasaur objectc that we'll use below
        Pokemon bulbasaur = new Pokemon("Bulbasaur", "Grass/Poison");

        //an enhanced for loop to compare each Pokemon object in the HashSet with bulbasaur above
        //"For every Pokemon object, which we'll call "p", in the pokemonSet, check if is equal to our bulbasaur
        for(Pokemon p : pokemonSet){
            System.out.println(bulbasaur.equals(p));
            //bulbasuar.equals(bulbasaur) == true, so we get true when we hit a bulbasaur
        }
        ...
        //This is a HashMap that will store people's names, which we cna access through an Integer Key.
        ...
        Wrapper Classes are the solution tot his.
