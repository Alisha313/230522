...
public class Launcher extends ScopeTester{
    ...
    public static void main(String[] args) {
        ...
        //instantiate a new ScopeTester object to demostate changing static/nonstatic variables
    ...
    public static void scopeMethod(){
        ...
        int methodScopeInt = 25; //this variable is METHOD SCOPED. only visible within this method
        ...
        if(true){
            ...
            System.out.println(methodScopeInt);
