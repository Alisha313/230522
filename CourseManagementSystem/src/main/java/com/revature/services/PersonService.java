...
public class PersonService {
    ...
    public List<Course> getCourseByPersonId(int id){
    ...
    public Person unregisteredForCourse(int pid, int cid){

        Person p = getPersonById(pid);

        //Now we need to extract the courses to add to is as necessary
        List<Course> courses = p.getCourses();

        //Now we need to search the courses table to find teh course with id = cid
        Optional<Course> returnedCourse = courseDAO.findById(cid);
