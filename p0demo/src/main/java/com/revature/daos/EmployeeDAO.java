...
public class EmployeeDAO implements EmployeeDAOInterface{
    ...
    public ArrayList<Employee> getAllEmployees() {
        ...
        try(Connection conn = ConnectionUtil.getConnection()) {
            ...
            BIG PICTURE: If we have no variables, Statement is fine, otherwise we need PreparedStatemet*/
            ...
            while(rs.next()){
                ...
                Employee employee = new Employee(
                        ...
                        //we needed to retrieve a Role object this way, because the DB just returns int PK
    ...
    public Employee insertEmployee(Employee emp) {
        ...
        try(Connection conn = ConnectionUtil.getConnection()){
            ...
            //Instantiate a PreparedStatement to hold our SQL String and fill its variable
